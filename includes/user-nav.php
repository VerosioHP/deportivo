...
/**
 * Navegación de usuario en la barra superior (login, sesión, logout).
 * Si la vista padre no incluyó auth.php, este archivo lo carga automáticamente.
 */
...
$loginUrl = $viewsPath . 'login.php';
$logoutUrl = $controllersPath . 'logout.php';
