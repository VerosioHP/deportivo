/**
 * Kinetic Noir — Tailwind design tokens
 * Fuente: css/DESIGN.md
 */
window.DeportivoTokens = {
    colors: {
        /* Accent — Electric Volt (mapeado a `secondary` en el markup existente) */
        "secondary": "#DFFF00",
        "on-secondary": "#0D0D0E",
        ...
        /* Inverse (dark surfaces en light mode) */
